        ...
        private void btnCapNhat_Click(object sender, EventArgs e)
        {
            if (kt == 1)
            {
                ...
                else
                {
                    ...
                    string sql2 = "Insert into NhanVienBoPhan(NhanVienID, BoPhanID) values ('" + cmbNhanVien.SelectedValue + "', '" + cmbBoPhan.SelectedValue + "')";
                    if (database.Execute(sql) == false || database.Execute(sql) == false)
                    {
